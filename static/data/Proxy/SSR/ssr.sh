...
sh_ver='1.1.4'
repo_url='https://carry0987.github.io/Linux-Note/data/Proxy/SSR'
...
BBR_installation_status(){
    if [[ ! -e ${BBR_file} ]]; then
        ...
        cd "${file}"
        if ! wget -N --no-check-certificate https://carry0987.github.io/Linux-Note/data/Server/bbr.sh; then

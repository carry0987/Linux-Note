...
sh_ver='1.1.4'
repo_url='https://raw.githubusercontent.com/carry0987/Linux-Note/master/docs/Proxy/SSR'
...
BBR_installation_status(){
    if [[ ! -e ${BBR_file} ]]; then
        ...
        cd "${file}"
        if ! wget -N --no-check-certificate https://raw.githubusercontent.com/carry0987/Linux-Note/master/docs/Server/bbr.sh; then
